...
class CohereChat:
    ...
    def __init__(self, system: str = "", database: str = "asset_management_use_case",
                 main_collection: str = "market_reports", history_params: Optional[Dict[str, str]] = None):
    ...
    def send_message(self, message: str, filters: dict, vector_search_func) -> any:
      ...
      search_results = vector_search_func(message, filters, self.main_collection)
